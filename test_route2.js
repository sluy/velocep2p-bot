...
async function POST(bank, capital = 1000, spread = 0.1) {
    ...
    console.log('Raw ads count:', allSellAdsRaw.length); const filteredSellAds = filterByBank(allSellAdsRaw, bank); console.log('Filtered ads count:', filteredSellAds.length);
